        ...
        <div class="am-tabs am-margin" data-am-tabs>
            ...
            <div class="am-tabs-bd">
                <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                    <form action="admin/update_img" method="post" class="am-form am-form-inline" enctype="multipart/form-data">
                        <input type="hidden" name="img_id" value="<?php echo $img -> img_id ;?>">
                        <div class="am-g am-margin-top">
                            <div class="am-u-sm-4 am-u-md-2 am-text-right">图片标题</div>
                            <div class="am-u-sm-8 am-u-md-4 am-u-end">
                                <input type="text" id="imgname" name="img_title" value="<?php echo $img -> img_title ;?>" >
                                <a id="tip" class="am-badge am-badge-danger am-square"><span class="am-icon-exclamation-triangle"></span> 当前用户名不可用</a>
                            </div>
                        </div>
                        <div class="am-g am-margin-top">
                            <div class="am-u-sm-4 am-u-md-2 am-text-right">图片描述</div>
                            <div class="am-u-sm-8 am-u-md-8 am-u-end">
                                <textarea name="img_desc" id="" cols="30" rows="10"><?php echo $img -> img_desc ;?></textarea>
                                <a id="tip" class="am-badge am-badge-danger am-square"><span class="am-icon-exclamation-triangle"></span> 当前用户名不可用</a>
                            </div>
                        </div>
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end">
                                <input type="hidden" name="photo_old_url" value="<?php echo $img -> img_src ;?>">
                                <img src="<?php echo $img -> img_src ;?>" style="width: 100%; height: 100%; cursor: pointer;" alt="当前用户头像缩略图" title="" data-am-popover="{content: '当前用户头像缩略图', trigger: 'hover focus'}"/>
                            </div>
                        </div>
                        <div class="am-g am-margin-top">
                            <div class="am-u-sm-4 am-u-md-2 am-text-right">更改图片</div>
                            <div class="am-u-sm-8 am-u-md-4 am-u-end">
                                <!--              文件上传-->
                                <div class="am-form-group am-form-file">
                                    <button type="button" class="am-btn am-btn-danger am-btn-sm">
                                        <i class="am-icon-cloud-upload"></i> 选择新的图片文件</button>
                                    <input id="doc-form-file" type="file" multiple name="img_photo">
                                    <!--图片预览-->
                                    <br/>
