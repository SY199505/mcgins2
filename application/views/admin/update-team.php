                    ...
                    <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                        <form action="admin/update_team" method="post" class="am-form am-form-inline" enctype="multipart/form-data">
                            ...
                            <div class="am-g am-margin-top">
                                ...
                                <div class="am-u-sm-8 am-u-md-4 am-u-end">
                                    <input type="text" id="teamname" name="team_type" value="<?php echo $team -> type ;?>">
                                    <a id="tip" class="am-badge am-badge-danger am-square"><span class="am-icon-exclamation-triangle"></span> 当前用户名不可用</a>
                                </div>
                            </div>
                            <div class="am-g am-margin-top">
                                ...
                                <div class="am-u-sm-8 am-u-md-8 am-u-end">
                                    ...
                                    <textarea name="team_desc" id="" cols="30" rows="10"><?php echo $team -> desc ;?></textarea>
                                    <a id="tip" class="am-badge am-badge-danger am-square"><span class="am-icon-exclamation-triangle"></span> 当前用户名不可用</a>
                                </div>
                            </div>
                            <div class="am-g am-margin-top">
                            ...
                            <div class="am-g am-margin-top">
                                ...
                                <div class="am-u-sm-8 am-u-md-4 am-u-end">
                                    ...
                                    <div class="am-form-group am-form-file">
                                        ...
                                        <i class="am-icon-cloud-upload"></i> 选择新的头像文件(建议使用宽高比相同的图片)</button>
                                        <input id="doc-form-file" type="file" multiple name="team_photo">
                                        <!--图片预览-->
                                        <br/>
