        ...
        <div class="am-tabs am-margin" data-am-tabs>
            ...
            <div class="am-tabs-bd">
                <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                    <form action="admin/update_feature_bg" method="post" class="am-form am-form-inline" enctype="multipart/form-data">
                        <div class="am-g am-margin-top">
                            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                                <div class="am-g am-margin-top">
                                    <div class="am-u-sm-4 am-u-md-2 am-text-right">当前图片</div>
                                    <div class="am-u-sm-8 am-u-md-8 am-u-end">
                                        <input type="hidden" name="feature_bg_old_url" value="<?php echo $carouselInfo[0] -> index_feature_bg ;?>">
                                        <img src="<?php echo $carouselInfo[0] -> index_feature_bg ;?>" style="width: 100%; height: 100%; cursor: pointer;" alt="当前新闻主图缩略图" title="" data-am-popover="{content: '当前新闻主图缩略图', trigger: 'hover focus'}"/>
                                    </div>
                                </div>
                                    ...
                                    <div class="am-u-sm-8 am-u-md-4 am-u-end">
                                        ...
                                        <div class="am-form-group am-form-file">
                                            <button type="button" class="am-btn am-btn-danger am-btn-sm">
                                                <i class="am-icon-cloud-upload"></i> 选择要上传的图片（建议使用1024*787大小的图片）</button>
                                            <input id="doc-form-file" type="file" multiple name="new_feature_bg">
                                            <!--图片预览-->
                                            <br/>
