...
<head>
    ...
    <title>更换轮播图 - McGins English后台管理</title>
        ...
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf">
                    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">更新轮播图</strong> | <a class="am-badge am-badge-success am-square">Update News</a></div>
                </div>
            </div>
            ...
            <div class="am-tabs am-margin" data-am-tabs>
                <ul class="am-tabs-nav am-nav am-nav-tabs">
                    <li class="am-active"><a href="#tab2">更新图片</a></li>
                </ul>
