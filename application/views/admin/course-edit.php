          ...
          <form class="am-form" action="admin/update_course" method="post">
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4">
                <input type="text" class="am-input-sm" name="levels" value="<?php echo $course -> levels;?>">
              </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                <input type="text" class="am-input-sm" name="age" value="<?php echo $course -> age;?>">
              </div>
            ...
            <div class="am-g am-margin-top">
              ...
              <div class="am-u-sm-8 am-u-md-4">
                <input type="text" class="am-input-sm" name="courses" value="<?php echo $course -> courses;?>">
              </div>
              <div class="am-hide-sm-only am-u-md-6">*必填</div>
            </div>
            ...
            <div class="am-g am-margin-top-sm">
              ...
              <div class="am-u-sm-12 am-u-md-10">
                <textarea id="intro" name="intro" rows="10" placeholder="请使用富文本编辑插件" style="height: 400px;"><?php echo $course -> intro;?></textarea>
              </div>
            </div>
