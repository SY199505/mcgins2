...
<head>
  ...
  <title>添加新闻 - McGins English后台管理</title>
  ...
  <div class="admin-content-body">
    <div class="am-cf am-padding am-padding-bottom-0">
      <div class="am-fl am-cf">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新增新闻界面</strong> | <a class="am-badge am-badge-success am-square">Add News</a></div>
      </div>
    </div>
    ...
    <div class="am-tabs am-margin" data-am-tabs>
      <ul class="am-tabs-nav am-nav am-nav-tabs">
        <li class="am-active"><a href="#tab2">新增新闻</a></li>
      </ul>

      <div class="am-tabs-bd">

        <div class="am-tab-panel am-fade am-in am-active" id="tab2">
          <form class="am-form" action="admin/save_news" method="post" enctype="multipart/form-data">
            ...
            <div class="am-g am-margin-top-sm">
              ...
              <div class="am-u-sm-12 am-u-md-10">
                <textarea id="news_content" name="news_content" rows="10"  style="height: 400px;"></textarea>
              </div>
            </div>
